...
rebuild_firmware() {
    ...
    my_packages="\
        ...
        containerd coremark coreutils coreutils-base64 coreutils-nohup \
        coreutils-truncate curl docker dockerd dosfstools dumpe2fs e2freefrag e2fsprogs \
        ...
        uclient-fetch unzip usb-modeswitch uuidgen wget-ssl whereis \
        ...
        luci-mod-status luci-mod-system luci-proto-bonding luci-proto-ipv6 \
        luci-proto-ppp luci-proto-relay \
        wireguard-tools luci-proto-wireguard ip-full nginx-full nginx-utils arp-scan arp-scan-database \
        ca-certificates \
        \
